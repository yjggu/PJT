...
<body>
	...
	<div id="main-container">
		<div id="container">
			<div class="tabs">
				<div class="tab" onclick="showTabContent('Mortgage')">주택담보대출</div>
				<div class="tab active" onclick="showTabContent('Lease')">전세자금대출</div>
				<div class="tab" onclick="showTabContent('Credit')">신용대출</div>
				<div class="tab" onclick="showTabContent('Car')">자동차대출</div>
			</div>
			<div id="content2">
				<!-- 주택담보대출 -->
				<div id="Mortgage" class="tab-content">
					...
					<div class="section">
						...
						<div class="table-container">
							<table>
								<tr>
									<th>최고한도</th>
									<td>담보조사가격 및 소득금액, 담보물건지 지역 등에 따른 대출가능금액 이내</td>
								</tr>
								<tr>
									<th>대출기간</th>
					...
					<div class="section">
						<h3>분양대금 잔금을 납부하려는 고객을 위한 주택구입자금대출(집단주잔금대출)</h3>
						<div class="table-container">
							<table>
								<tr>
									<th>대출대상</th>
					...
					<div class="section">
						<h3>일반부동산(주택제외)을 담보로 신청하는 일반부동산 담보대출</h3>
						<div class="table-container">
							<table>
								<tr>
									<th>최고한도</th>
				...
				<!-- 전세자금대출 -->
				<div id="Lease" class="tab-content active">
					...
					<div class="section">
						...
						<div class="table-container">
							...
							<p>「전세보증금반환보증」 가입으로 임차보증금을 안전하게 보장</p>
							<br /> <br /> <br />
							<p>* 모든 전세자금대출은 연소득, 부채금액 등 개인별 신용평가에 의해 최종 대출금액 결정</p>
						</div>
					</div>
				</div>
				<!-- 전세자금대출 -->
					...
					<div class="section">
						...
						<div class="table-container">
							<table>
								<tr>
									<th>대출대상</th>
									<td>재직 및 소득을 증빙할 수 있는 직장인 이라면 신청 가능한 상품</td>
								</tr>
								<tr>
									<th>대출한도</th>
					...
					<div class="section">
						...
						<div class="table-container">
							<table>
								<tr>
									<th>대출대상</th>
									<td>의사전용 신용대출로 대출한도 및 대출금리를 우대한 상품.<br /> 근로소득 또는 사업소득이
										있는 현직의사(전문의, 레지던트, 인턴, 군의관, 공중보건의 포함), 한의사, 치과의사, 또는 개업예정의(의사,
										한의사, 치과의사), 의대본과 4학년 및 의사면허합격자(치의대,한의대 포함)로서 개인신용평가시스템(CSS)에
										의해 대출적격자로 판정된 고객
									</td>
								</tr>
								<tr>
					...
					<div class="section">
						...
						<div class="table-container">
							<table>
								<tr>
									<th>대출대상</th>
									<td>일정한 국내자격증을 소지한 현직종사자 (수의사, 약사, 공인회계사, 세무사, 관세사, 변리사,
										기술사, 도선사, 건축사, 법무사, 감정평가사, 공인노무사, 손해사정인 )를 대상으로 무보증으로 간편하게
										대출해드리는 상품</td>
								</tr>
								<tr>
									<th>대출한도</th>
									<td>자격증 종류 및 연소득과 신용등급에 따라 대출한도 차등 적용</td>
								</tr>
							</table>
						</div>
					</div>
					...
					<div class="section">
						...
						<div class="table-container">
							<table>
								<tr>
									<th>상품특징</th>
									<td>- 캐피탈 대비 유리한 금리조건으로 신규 및 중고차를 구매하려는 고객을 위한 맞춤상품 <br />
										- 별도의 취급수수료, 보험료, 근저당설정 부담 없음 <br /> - 다른 금융기관(은행권 제외)에서 받은
										자동차할부금융을 대환 가능
									</td>
								</tr>
								<tr>
	...
	<script>
		function showTabContent(tabId) {
			...
			document.querySelector('.tabs .tab[onclick="showTabContent(\''
