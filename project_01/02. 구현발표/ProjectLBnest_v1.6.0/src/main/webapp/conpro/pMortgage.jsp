...
body {
   background-image: url('../resources/yj_image/consult08.jpg');
   background-repeat: no-repeat;		 /* 이미지 반복 안함 */
   background-size: cover; 				 /* 이미지가 화면 전체를 덮도록 조정 */
   background-position: center;         /* 이미지의 중간 부분을 배경으로 설정 (가로 50%, 세로 30%) */
   margin: 0;
   padding: 0;
   position: relative;
   zoom: 1; 
				...
				<div id="leftColumn">
					...
					<ul>
						<c:forEach var="product" items="${productList}">
							<c:if test="${product.classification == '주택담보대출'}">
								<li><a href="#"
