...
<body>
   ...
   <div class="main_container">
        <div id="wrapper">
            <div id="container_wr">
                <div id="container">
                    <section id="registration-card" class="registration-card" style="background-color: white;">
                        <div class="overlay-text" data-aos="zoom-in" data-aos-delay="200" style="color: black; text-align: center; font-weight:bold; font-size:45px;">
                            대출모집인 등록증(법인)
                        </div>
                        <div style="position: relative; text-align: center;" data-aos="zoom-in" data-aos-delay="200">
                            <img src="${pageContext.request.contextPath}/resources/main_image/registration.jpg" alt="대출모집법인 이미지" style="max-width: 100%;">
                        </div>
                    </section>
                </div>
            </div>
